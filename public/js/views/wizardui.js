define(['jquery', 'underscore', 'backbone', 'text!templates/wizard/container.html'],
function ($, _, Backbone, WizardViewTemplate) {
    ...
    var Wizard = Backbone.View.extend({
        ...
        render: function () {
            $(this.el).html(_.template(WizardViewTemplate));
